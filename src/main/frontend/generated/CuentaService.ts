...
<<<<<<< HEAD
async function getCurrentUserInfo_1(init?: EndpointRequestInit_1): Promise<Record<string, unknown> | undefined> { return client_1.call("CuentaService", "getCurrentUserInfo", {}, init); }
async function getUserId_1(init?: EndpointRequestInit_1): Promise<number | undefined> { return client_1.call("CuentaService", "getUserId", {}, init); }
...
async function isCurrentUserAdmin_1(init?: EndpointRequestInit_1): Promise<boolean | undefined> { return client_1.call("CuentaService", "isCurrentUserAdmin", {}, init); }
=======
>>>>>>> origin/develop
...
async function update_1(id: number | undefined, clave: string | undefined, claveNueva: string | undefined, init?: EndpointRequestInit_1): Promise<void> { return client_1.call("CuentaService", "update", { id, clave, claveNueva }, init); }
...
<<<<<<< HEAD
export { buscar_1 as buscar, create_1 as create, createRoles_1 as createRoles, createUsuarios_1 as createUsuarios, getAuthentication_1 as getAuthentication, getCurrentUserInfo_1 as getCurrentUserInfo, getUserId_1 as getUserId, getUserInfo_1 as getUserInfo, isCurrentUserAdmin_1 as isCurrentUserAdmin, isLogin_1 as isLogin, listCuenta_1 as listCuenta, login_1 as login, logout_1 as logout, main_1 as main, ordenar_1 as ordenar, update_1 as update, view_rol_1 as view_rol };
=======
export { buscar_1 as buscar, create_1 as create, createRoles_1 as createRoles, createUsuarios_1 as createUsuarios, getAuthentication_1 as getAuthentication, isLogin_1 as isLogin, listCuenta_1 as listCuenta, login_1 as login, logout_1 as logout, ordenar_1 as ordenar, update_1 as update, view_rol_1 as view_rol };
>>>>>>> origin/develop
