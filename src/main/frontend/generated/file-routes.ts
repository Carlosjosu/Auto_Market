...
import * as Page_8 from "../views/valoracion-list.js";
import * as Page_9 from "../views/venta-list.js";
const routes: readonly AgnosticRoute_1[] = [
    createRoute_1("", Layout_1, [
        ...
        createRoute_1("valoracion-list", Page_8),
        createRoute_1("venta-list", Page_9)
    ])
];
