...
import * as Page_4 from "../views/valoracion-list.js";
import * as Page_5 from "../views/venta-list.js";
const routes: readonly AgnosticRoute_1[] = [
    createRoute_1("", Layout_1, [
        ...
        createRoute_1("valoracion-list", Page_4),
        createRoute_1("venta-list", Page_5)
    ])
];
