...
public class DaoConversacion extends AdapterDao<Conversacion> {
    ...
    public LinkedList<Conversacion> getConversacionesPorUsuario(Integer usuarioId) {
        return filtrarConLinkedList(c -> 
            c.getIdEmisor().equals(usuarioId) || c.getIdReceptor().equals(usuarioId)
        );
    }
    ...
    public Conversacion crearOBuscarConversacion(Integer idEmisor, Integer idReceptor, Integer idAuto) throws Exception {
    ...
    public LinkedList<Integer> encontrarRutaEntreUsuarios(Integer origen, Integer destino) {
