...
async function buscar_1(atributo: string | undefined, valor: string | undefined, init?: EndpointRequestInit_1): Promise<Array<Valoracion_1 | undefined> | undefined> { return client_1.call("ValoracionService", "buscar", { atributo, valor }, init); }
...
export { buscar_1 as buscar, create_1 as create, listValoracion_1 as listValoracion, ordenar_1 as ordenar };
