...
function join_1(): Subscription_1<Mensaje_1 | undefined> { return client_1.subscribe("ChatService", "join", {}); }
...
export { crearConversacion_1 as crearConversacion, enviarMensaje_1 as enviarMensaje, getConversacionDao_1 as getConversacionDao, join_1 as join, obtenerConversacionesUsuario_1 as obtenerConversacionesUsuario, obtenerMensajesConversacion_1 as obtenerMensajesConversacion };
