...
import * as Page_7 from "../views/marca-list.js";
import * as Page_8 from "../views/Marca.js";
import * as Page_9 from "../views/MensajeView.js";
...
const routes: readonly AgnosticRoute_1[] = [
    createRoute_1("", Layout_1, [
        ...
        createRoute_1("Marca", Page_8),
        createRoute_1("marca-list", Page_7),
        createRoute_1("MensajeView", Page_9),
